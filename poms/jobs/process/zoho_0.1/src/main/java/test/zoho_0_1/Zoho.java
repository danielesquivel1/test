...
/**
 * Job: Zoho Purpose: Ingest Zoho mensual data<br>
 * Description: Ingest Zoho data for analitucs <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Zoho implements TalendJob {
	...
	private final String jobName = "Zoho";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Zoho.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TEST_Zoho = new byte[0];
		static byte[] commonByteArray_TEST_Zoho = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_TEST_Zoho) {
...
///////////////////////    			
				...
				Object source_tFileInputExcel_2 = "C:/Users/daniel.esquivel/Documents/Radix/Data/Zoho Data/202205May_initial_response all clients.csv";
				...
				try {
					...
					if (sheetList_tFileInputExcel_2.size() > 0) {
						...
						for (int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++) {
							...
							row1 = null;
							int tempRowLength_tFileInputExcel_2 = 0;
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Zoho ZohoClass = new Zoho();

		int exitCode = ZohoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Zoho.class.getClassLoader()
					.getResourceAsStream("test/zoho_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Zoho.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Zoho");
		}
...
/************************************************************************************************
 * 39993 characters generated by Talend Open Studio for Data Integration on the
 * October 18, 2022 at 10:28:24 AM CDT
 ************************************************************************************************/